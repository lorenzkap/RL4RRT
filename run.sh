...
if [ "$command" = "extract" ]; then
  ...
  python ai_clinician/preprocessing/03_build_patient_states.py data/intermediates/sepsis_cohort --window-before 1 --window-after 241 || exit 1
  ...
  python ai_clinician/preprocessing/05_build_states_and_actions.py data/intermediates/sepsis_cohort/patient_states_filled.csv data/intermediates/sepsis_cohort/qstime.csv data/intermediates/sepsis_cohort/states_and_actions.csv --window-before 1 --window-after 241 --mapping-file data/intermediates/sepsis_cohort/bin_mapping.csv || exit 1
  ...
  echo "12/11 EXTRACT HEIGHT AND WEIGHT"
  python ai_clinician/preprocessing/height_weight.py $2 || exit 1
