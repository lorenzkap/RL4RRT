...
def main():
    ...
    # Optionally, append a weight for the RRT column
    feature_weights = np.append(feature_weights, 1)

    # CSV file to which we will append the evaluation results
    csv_file = os.path.join(data_dir, "evaluation_results_mimic.csv")
    ...
    for penalty in penalty_values:
        ...
        for model_idx in range(5):
            ...
            try:
                ...
                model_stats = evaluate_model(model_path, data_dir, MIMICzs, MIMICraw, metadata, actions_RRT, reduced_features)
