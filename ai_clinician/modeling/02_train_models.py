...
if __name__ == '__main__':
    ...
    for modl in range(args.n_models):
        ...
        phys_probs_all = base_model.compute_physician_probabilities(states=states_val)
        model_probs = model.compute_probabilities(X=X_val.values, actions=actions_val)
        model_probs_all = model.compute_probabilities(X=X_val.values)
        ...
        if save_name:
            ...
            additional_vars = {
                ...
                'actions_val': actions_val,
                'metadata_val': metadata_val,
                'phys_probs': phys_probs_all,
                'model_probs': model_probs_all,
