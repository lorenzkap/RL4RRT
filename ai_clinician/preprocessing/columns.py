...
C_RESPIRATORY_RATE = 'Respiratory_Rate'
C_ULTRAFILTRATE_OUTPUT = 'Ultrafiltrate_Output'
C_BLOOD_FLOW = 'Blood_Flow'
C_HOURLY_PATIENT_FLUID_REMOVAL = 'Hourly_Patient_Fluid_Removal'
C_DIALYSATE_RATE = 'Dialysate_Rate'
C_APACHEII_RENAL_FAILURE = 'APACHEII_Renal_Failure'
C_HEMODIALYSIS_OUTPUT = 'Hemodialysis_Output'
C_CITRATE = 'Citrate'
C_PREFILTER_REPLACEMENT_RATE = 'Prefilter_Replacement_Rate'
C_POSTFILTER_REPLACEMENT_RATE = 'Postfilter_Replacement_Rate'
...
C_ETCO2 = 'ETCO2'
C_SVO2 = 'SvO2'
C_ANION_GAP = 'Anion_Gap'
C_AMMONIA = 'Ammonia'
C_FIBRINOGEN = 'Fibrinogen'
# C_ALT = 'ALT'
C_ABSOLUTE_NEUTROPHIL_COUNT = 'Absolute_Neutrophil_Count'
C_PHOSPHOROUS = 'Phosphorous'
C_SAO2 = 'SaO2'
C_TRIGLYCERIDE = 'Triglyceride'
C_SCVO2 = 'ScvO2'
C_LDH = 'LDH'
C_CK_MB = 'CK_MB'
C_BNP = 'BNP'
C_IRON = 'Iron'
C_THYROID_STIMULATING_HORMONE = 'Thyroid_Stimulating_Hormone'
C_CREATININE_URINE = 'Creatinine_Urine'
C_POTASSIUM_URINE = 'Potassium_Urine'
C_SODIUM_URINE = 'Sodium_Urine'
C_UREA_NITROGEN_URINE = 'Urea_Nitrogen_Urine'
C_CREATININE_CLEARANCE = 'Creatinine_Clearance'
C_T3 = 'T3'
C_GAMMA_GLUTAMYLTRANSFERASE = 'Gamma_Glutamyltransferase'
C_MYOGLOBIN = 'Myoglobin'
C_HEPARIN_LMW = 'Heparin_LMW'
C_OSMOLALITY_URINE = 'Osmolality_Urine'
C_INSULIN = 'Insulin'
...
DTYPE_SPEC = {
    ...
    C_ONSET_TIME: pd.Int64Dtype(),
    C_DISCHTIME: pd.Int64Dtype(),
    C_INTIME: pd.Int64Dtype(),
    C_OUTTIME: pd.Int64Dtype(),
    C_AGE: pd.Int64Dtype(),
    C_DOD: pd.Int64Dtype()
    # C_CHARTTIME: pd.Int64Dtype(),
    # C_CHARTDATE: pd.Int64Dtype(),
    # C_STARTDATE: pd.Int64Dtype(),
    # C_STARTTIME: pd.Int64Dtype(),
    # C_ENDDATE: pd.Int64Dtype()
    # C_ENDTIME: pd.Int64Dtype()
}
...
CHART_FIELD_NAMES = [
    C_HEIGHT, C_WEIGHT, C_GCS, C_RASS, C_HR, C_SYSBP, C_MEANBP, C_DIABP, C_RR, C_SPO2, C_TEMP_C,
    C_TEMP_F, C_CVP, C_PAPSYS, C_PAPMEAN, C_PAPDIA, C_CI, C_SVR, C_INTERFACE, C_FIO2_100, C_FIO2_1,
    C_O2FLOW, C_PEEP, C_TIDALVOLUME, C_MINUTEVENTIL, C_PAWMEAN, C_PAWPEAK, C_PAWPLATEAU,
    C_RESPIRATORY_RATE, C_ULTRAFILTRATE_OUTPUT, C_BLOOD_FLOW, C_HOURLY_PATIENT_FLUID_REMOVAL,
    C_DIALYSATE_RATE, C_APACHEII_RENAL_FAILURE, C_HEMODIALYSIS_OUTPUT, C_CITRATE,
    C_PREFILTER_REPLACEMENT_RATE, C_POSTFILTER_REPLACEMENT_RATE
]

LAB_FIELD_NAMES = [
    C_POTASSIUM, C_SODIUM, C_CHLORIDE, C_GLUCOSE, C_BUN, C_CREATININE, C_MAGNESIUM, C_CALCIUM,
    C_IONISED_CA, C_CO2_MEQL, C_SGOT, C_SGPT, C_TOTAL_BILI, C_DIRECT_BILI, C_TOTAL_PROTEIN,
    C_ALBUMIN, C_TROPONIN, C_CRP, C_HB, C_HT, C_RBC_COUNT, C_WBC_COUNT, C_PLATELETS_COUNT,
	C_PTT, C_PT, C_ACT, C_INR, C_ARTERIAL_PH, C_PAO2, C_PACO2, C_ARTERIAL_BE, C_ARTERIAL_LACTATE,
	# C_HCO3, C_ETCO2, C_SVO2, C_ANION_GAP, C_AMMONIA, C_FIBRINOGEN, C_ALT, C_ABSOLUTE_NEUTROPHIL_COUNT,
    C_HCO3, C_ETCO2, C_SVO2, C_ANION_GAP, C_AMMONIA, C_FIBRINOGEN, C_ABSOLUTE_NEUTROPHIL_COUNT,
    C_PHOSPHOROUS,  C_SAO2, C_TRIGLYCERIDE, C_SCVO2, C_LDH, C_CK_MB, C_BNP, C_IRON,
    C_THYROID_STIMULATING_HORMONE, C_CREATININE_URINE, C_POTASSIUM_URINE, C_SODIUM_URINE, 
    C_UREA_NITROGEN_URINE, C_CREATININE_CLEARANCE, C_T3, C_GAMMA_GLUTAMYLTRANSFERASE, C_MYOGLOBIN,
    C_HEPARIN_LMW, C_OSMOLALITY_URINE, C_INSULIN
]
...
SAH_HOLD_DURATION = {f: v for f, v in zip(SAH_FIELD_NAMES, [
    168, 72, 6, 6, 2, 2, 2, 2, 2, 2, 6, 6, 2, 2, 2, 2, 2, 2, 24, 12, 12, 12, 6, 6, 6, 6, 6,
	6, 2, 6, 2, 6, 6, 24, 6, 6, 6, 6, 144, 14, 14, 14, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 28, 14, 28, 28,
    28, 28, 28, 28, 28, 28, 8, 8, 8, 8, 8, 8, 8, 8, 28, 28, 28, 28, 28, 2, 28, 8, 28, 28, 28, 28, 28, 28, 28, 28,
