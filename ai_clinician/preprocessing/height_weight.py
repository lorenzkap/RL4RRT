...
def main():
    # Check if input dataset path is provided as an argument
    if len(sys.argv) < 2:
        print("Please provide the dataset directory name as an argument.")
        sys.exit(1)
    
    # Construct input dataset path
    input_dataset_path = f"data/{sys.argv[1]}/mimic_dataset.csv"
